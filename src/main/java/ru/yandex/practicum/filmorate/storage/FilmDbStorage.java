...
public class FilmDbStorage implements FilmStorage {
    ...
    public List<Film> getRecommendationForUser(int id) {
        /** Тут должна была быть проверка на корректность/существования id пользователя.
         * Но тогда пришлось бы тянуть в этот класс зависимость от UserStorage.
         * Мой ревьюер на это ругался...
         * Как выриант - сделать для рекомандаций всё своё (controller - уже есть, service, storage)
         */
